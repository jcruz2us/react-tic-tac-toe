...
/***/ function(module, exports, __webpack_require__) {
	...
	var thunkMiddleware = __webpack_require__(190).default;

	var _require2 = __webpack_require__(192);

	var TTTBoard = _require2.TTTBoard;
	...
	var gameReducer = function gameReducer(state, action) {
	  ...
	  switch (action.type) {
	    ...
	    case UPDATE_GAME:
	      ...
	      var disabled = game.over;
	      return Object.assign({}, game, { disabled: disabled });
	    default:
	      return state;
	  }
	};
	...
	var Application = function Application(props) {
	  ...
	  var gameResult = function gameResult() {
	    return React.createElement('p', null, ['Game Over: ', game.tie ? 'Tie!' : game.winner + ' wins!']);
	  };

	  var nextPlayer = function nextPlayer() {
	    return React.createElement('p', null, 'Up Next: ' + game.current);
	  };

	  return React.createElement('div', null, [React.createElement('h1', { className: 'page-header' }, 'Tic Tac Toe'), React.createElement('div', { className: 'subheader' }, [game.disabled && startButton(), game.over && gameResult(), !game.disabled && nextPlayer()]), React.createElement(TTTBoard, {
	    board: game.board,
	    onClick: function onClick(e, move) {
	      return store.dispatch(makeMove(move));
	    }
	  })]);
	};
	...
	var render = function render() {
	  return ReactDOM.render(React.createElement(Application), mountPoint);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var format = function format(play) {
	  return play === 'e' ? '' : play;
	};

	var TTTBoard = function TTTBoard(props) {
	  ...
	  return React.createElement('div', { className: 'tttboard', onClick: handleBoxClick }, [React.createElement('div', { className: 'row' }, [React.createElement('div', { className: 'box', 'data-index': 0 }, format(board[0])), React.createElement('div', { className: 'box', 'data-index': 1 }, format(board[1])), React.createElement('div', { className: 'box', 'data-index': 2 }, format(board[2]))]), React.createElement('div', { className: 'row' }, [React.createElement('div', { className: 'box', 'data-index': 3 }, format(board[3])), React.createElement('div', { className: 'box', 'data-index': 4 }, format(board[4])), React.createElement('div', { className: 'box', 'data-index': 5 }, format(board[5]))]), React.createElement('div', { className: 'row' }, [React.createElement('div', { className: 'box', 'data-index': 6 }, format(board[6])), React.createElement('div', { className: 'box', 'data-index': 7 }, format(board[7])), React.createElement('div', { className: 'box', 'data-index': 8 }, format(board[8]))])]);
	};
